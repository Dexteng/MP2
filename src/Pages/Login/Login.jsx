            ...
            <div className='form-container'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="input-box" >
                        ...
                        <input className="login-username" type="username" placeholder='   Username' onChange={changeUsername.bind(this)}/>
                    </div>

                    <div className='input-box'>
                        <i className='pass-icon'><FaLock /></i>
                        <input className="login-password" type="password" placeholder='   Password' onChange={changePassword.bind(this)} />
                    </div>
